        ...
        <div className="relative z-10 space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              {project.badge && (
                <span className="text-[10px] uppercase font-bold tracking-wider px-3 py-1 rounded-full bg-primary/10 text-primary border border-primary/20">
                  {project.badge}
                </span>
              )}
            </div>
          ...
          <div className="space-y-1">
            {project.category && (
              <span className="text-[11px] font-bold uppercase tracking-[0.2em] text-primary/90 block">
                {project.category}
              </span>
            )}
          ...
          <div className="flex flex-wrap items-center gap-6 pt-4">
            ...
            {project.github && project.github !== "#" ? (
              ...
              <span className="flex items-center gap-2 text-xs font-semibold tracking-wider text-muted-foreground/60">
                <Github size={14} />
                Codebase Private / Pending Verification
              </span>
            )}
